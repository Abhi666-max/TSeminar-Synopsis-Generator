        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-8 mt-12 border-t border-white/10">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6 bg-white/5 backdrop-blur-xl border border-white/10 px-6 py-3 rounded-full shadow-[0_4px_30px_rgba(0,0,0,0.1)]">
            ...
            <div className="flex items-center gap-4">
              <motion.a whileHover={{ scale: 1.2, rotate: 5 }} href="https://github.com/Abhi666-max/kse-synopsis-generator" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white transition-all duration-300 drop-shadow-[0_0_10px_rgba(255,255,255,0)] hover:drop-shadow-[0_0_10px_rgba(255,255,255,0.8)]" title="GitHub">
